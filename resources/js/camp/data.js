...
Camp.LANGS = {
  en: {
    title: 'HELLO EXPLORERS CAMP 2026',
    balance: 'Shells',
    distance: 'Distance',
    tonight: 'tonight',
    notSailedYet: 'not sailed',
    awardTitle: 'Award shells',
    awardHint: 'Shells earned in camp games',
    done: 'Done',
    boat: 'Boat',
    shop: 'Shipyard',
    play: 'PLAY',
  ...
  cs: {
    ...
    distance: 'Vzdálenost',
    tonight: 'dnes',
    notSailedYet: 'nevypluli',
    awardTitle: 'Udělit mušle',
    awardHint: 'Mušle získané ve hrách',
    done: 'Hotovo',
    boat: 'Loď',
    shop: 'Loděnice',
    play: 'HRÁT',
    ...
    items: {
      pan:        { name: 'Pánev',                  desc: 'Pádlování nádobím. Palivo na 18 s.' },
      oar:        { name: 'Dřevěné veslo',          desc: 'Konečně pořádné veslo. Palivo na 30 s.' },
      emotor:     { name: 'Elektromotor',           desc: 'Vrní jako lednička. Palivo na 45 s.' },
      petrol:     { name: 'Benzínový motor',        desc: 'Řve a smrdí, ale jede. Palivo na 65 s.' },
      turbine:    { name: 'Lodní turbína',          desc: 'Skoro letadlo. Palivo na 90 s.' },
      tshirt:     { name: 'Děravé tričko',          desc: 'Víc děr než trička. Vítr ×1,15 na 4 s.' },
      bedsheet:   { name: 'Plachta z prostěradla',  desc: 'Vypůjčeno z ložnice. Vítr ×1,25 na 5,5 s.' },
      frigate:    { name: 'Fregatní oplachtění',    desc: 'Plné plachtoví! Vítr ×1,35 na 7 s.' },
      spinnaker:  { name: 'Závodní spinakr',        desc: 'Nafoukne se v barvách týmu. Vítr ×1,5 na 8,5 s.' },
      dragon:     { name: 'Dračí plachta',          desc: 'Prý pochází z ostrova. Vítr ×1,65 na 10 s.' },
      raft:       { name: 'Vor z klád',             desc: 'Tři klády a kus lana. Rychlost 24 m/s.' },
      inflatable: { name: 'Nafukovací člun',        desc: 'Houpe se, ale sviští. Rychlost 30 m/s.' },
      speedboat:  { name: 'Motorový člun',          desc: 'Tohle už je jízda. Rychlost 38 m/s.' },
      catamaran:  { name: 'Závodní katamarán',      desc: 'Dva trupy, žádné brzdy. Rychlost 46 m/s.' },
      galleon:    { name: 'Pirátská galeona',       desc: 'Postrach všech moří. Rychlost 54 m/s.' },
...
Camp.CATALOG = {
  motor: [
    { id: 'pan',       name: 'Frying Pan',     price: 0,  starter: true, fuelSec: 18,
      desc: 'Paddling with cookware. 18 s of fuel.' },
    { id: 'oar',       name: 'Wooden Oar',     price: 25, fuelSec: 30,
      desc: 'A real oar at last. 30 s of fuel.' },
    { id: 'emotor',    name: 'Electric Motor', price: 60, fuelSec: 45,
      desc: 'Hums like a fridge. 45 s of fuel.' },
    { id: 'petrol',    name: 'Petrol Motor',   price: 120, fuelSec: 65,
      desc: 'Loud, smelly, glorious. 65 s of fuel.' },
    { id: 'turbine',   name: 'Marine Turbine', price: 200, fuelSec: 90,
      desc: 'Basically an airplane. 90 s of fuel.' },
  ],
  sail: [
    { id: 'tshirt',    name: 'Holey T-Shirt',  price: 0,  starter: true, windMult: 1.15, windSec: 4,
      desc: 'More hole than shirt. Wind boost ×1.15 for 4 s.' },
    { id: 'bedsheet',  name: 'Bedsheet Sail',  price: 25, windMult: 1.25, windSec: 5.5,
      desc: 'Borrowed from the bunkhouse. Wind boost ×1.25 for 5.5 s.' },
    { id: 'frigate',   name: 'Frigate Multi-Sail', price: 60, windMult: 1.35, windSec: 7,
      desc: 'Full rigging! Wind boost ×1.35 for 7 s.' },
    { id: 'spinnaker', name: 'Racing Spinnaker', price: 120, windMult: 1.5, windSec: 8.5,
      desc: 'Balloons out in team colors. Wind ×1.5 for 8.5 s.' },
    { id: 'dragon',    name: 'Dragon Sail',    price: 200, windMult: 1.65, windSec: 10,
      desc: 'They whisper it came from the island. Wind ×1.65 for 10 s.' },
  ],
  boat: [
    { id: 'raft',      name: 'Log Raft',       price: 0,  starter: true, speed: 240,
      desc: 'Three logs and some rope. Base speed 24 m/s.' },
    { id: 'inflatable',name: 'Inflatable Raft',price: 30, speed: 300,
      desc: 'Bouncy but quick. Base speed 30 m/s.' },
    { id: 'speedboat', name: 'Speedboat',      price: 75, speed: 380,
      desc: 'Now we are talking. Base speed 38 m/s.' },
    { id: 'catamaran', name: 'Racing Catamaran', price: 150, speed: 460,
      desc: 'Two hulls, zero brakes. Base speed 46 m/s.' },
    { id: 'galleon',   name: 'Pirate Galleon', price: 260, speed: 540,
      desc: 'Terror of every sea. Base speed 54 m/s.' },
  ],
  hull: [
...
Camp.TUNING = {
  ...
  obstacleGapPx: 135,  // average world-px between obstacle waves early on
  minObstacleGapPx: 84, // densest it ever gets
  rampMeters: 1100,    // density reaches max after this many meters
};
