...
Camp.LANGS = {
  ...
  cs: {
    ...
    items: {
      pan:        { name: 'Pánev',                  desc: 'Pádlování nádobím. Palivo na 25 s.' },
      oar:        { name: 'Dřevěné veslo',          desc: 'Konečně pořádné veslo. Palivo na 45 s.' },
      emotor:     { name: 'Elektromotor',           desc: 'Vrní jako lednička. Palivo na 70 s.' },
      petrol:     { name: 'Benzínový motor',        desc: 'Řve a smrdí, ale jede. Palivo na 100 s.' },
      turbine:    { name: 'Lodní turbína',          desc: 'Skoro letadlo. Palivo na 145 s.' },
      tshirt:     { name: 'Děravé tričko',          desc: 'Víc děr než trička. Vítr ×1,25 na 4 s.' },
      bedsheet:   { name: 'Plachta z prostěradla',  desc: 'Vypůjčeno z ložnice. Vítr ×1,5 na 5,5 s.' },
      frigate:    { name: 'Fregatní oplachtění',    desc: 'Plné plachtoví! Vítr ×1,8 na 7 s.' },
      spinnaker:  { name: 'Závodní spinakr',        desc: 'Nafoukne se v barvách týmu. Vítr ×2,1 na 8,5 s.' },
      dragon:     { name: 'Dračí plachta',          desc: 'Prý pochází z ostrova. Vítr ×2,4 na 10 s.' },
      raft:       { name: 'Vor z klád',             desc: 'Tři klády a kus lana. Rychlost 19 m/s.' },
      inflatable: { name: 'Nafukovací člun',        desc: 'Houpe se, ale sviští. Rychlost 24 m/s.' },
      speedboat:  { name: 'Motorový člun',          desc: 'Tohle už je jízda. Rychlost 30 m/s.' },
      catamaran:  { name: 'Závodní katamarán',      desc: 'Dva trupy, žádné brzdy. Rychlost 36 m/s.' },
      galleon:    { name: 'Pirátská galeona',       desc: 'Postrach všech moří. Rychlost 42 m/s.' },
...
Camp.CATALOG = {
  motor: [
    { id: 'pan',       name: 'Frying Pan',     price: 0,  starter: true, fuelSec: 25,
      desc: 'Paddling with cookware. 25 s of fuel.' },
    { id: 'oar',       name: 'Wooden Oar',     price: 25, fuelSec: 45,
      desc: 'A real oar at last. 45 s of fuel.' },
    { id: 'emotor',    name: 'Electric Motor', price: 60, fuelSec: 70,
      desc: 'Hums like a fridge. 70 s of fuel.' },
    { id: 'petrol',    name: 'Petrol Motor',   price: 120, fuelSec: 100,
      desc: 'Loud, smelly, glorious. 100 s of fuel.' },
    { id: 'turbine',   name: 'Marine Turbine', price: 200, fuelSec: 145,
      desc: 'Basically an airplane. 145 s of fuel.' },
  ],
  sail: [
    { id: 'tshirt',    name: 'Holey T-Shirt',  price: 0,  starter: true, windMult: 1.25, windSec: 4,
      desc: 'More hole than shirt. Wind boost ×1.25 for 4 s.' },
    { id: 'bedsheet',  name: 'Bedsheet Sail',  price: 25, windMult: 1.5, windSec: 5.5,
      desc: 'Borrowed from the bunkhouse. Wind boost ×1.5 for 5.5 s.' },
    { id: 'frigate',   name: 'Frigate Multi-Sail', price: 60, windMult: 1.8, windSec: 7,
      desc: 'Full rigging! Wind boost ×1.8 for 7 s.' },
    { id: 'spinnaker', name: 'Racing Spinnaker', price: 120, windMult: 2.1, windSec: 8.5,
      desc: 'Balloons out in team colors. Wind ×2.1 for 8.5 s.' },
    { id: 'dragon',    name: 'Dragon Sail',    price: 200, windMult: 2.4, windSec: 10,
      desc: 'They whisper it came from the island. Wind ×2.4 for 10 s.' },
  ],
  boat: [
    { id: 'raft',      name: 'Log Raft',       price: 0,  starter: true, speed: 190,
      desc: 'Three logs and some rope. Base speed 19 m/s.' },
    { id: 'inflatable',name: 'Inflatable Raft',price: 30, speed: 240,
      desc: 'Bouncy but quick. Base speed 24 m/s.' },
    { id: 'speedboat', name: 'Speedboat',      price: 75, speed: 300,
      desc: 'Now we are talking. Base speed 30 m/s.' },
    { id: 'catamaran', name: 'Racing Catamaran', price: 150, speed: 360,
      desc: 'Two hulls, zero brakes. Base speed 36 m/s.' },
    { id: 'galleon',   name: 'Pirate Galleon', price: 260, speed: 420,
      desc: 'Terror of every sea. Base speed 42 m/s.' },
  ],
  hull: [
...
Camp.TUNING = {
  pxPerMeter: 10,
  windSpawnMin: 4.5,   // seconds between wind charge spawns (min)
  windSpawnMax: 9.0,   // seconds between wind charge spawns (max)
